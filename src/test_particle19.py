...
def main():
    ...
    save_file = save_dir + '/model.hyp' if not args.lm_data else save_dir + '/lm.hyp'
    save_file_char = save_dir + '/model_char.hyp' if not args.lm_data else save_dir + '/lm_char.hyp'
    save_file_out = save_dir + '/model.out' if not args.lm_data else save_dir + '/lm.out'
    save_file_m2score = save_dir + '/m2score.txt' if not args.lm_data else save_dir + '/m2score_lm.txt'
